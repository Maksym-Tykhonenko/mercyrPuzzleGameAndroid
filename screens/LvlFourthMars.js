...
const LvlFourthMars = ({navigation}) => {
  ...
  console.log('jupiterAnlock===>', jupiterAnlock);
  ...
  const setData = async () => {
    try {
      ...
      await AsyncStorage.setItem('LvlFourthMars', jsonData);
        ...
        <View
          ...
          <View style={{flexDirection: 'row'}}>
            <Image
              ...
              source={require('../assets/planats/marsLvls.jpg')}
            />
          </View>
          {/**BTN back */}
          <TouchableOpacity
